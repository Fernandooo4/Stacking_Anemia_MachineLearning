...
modelo = joblib.load("Algorit/tabnet_model.pkl") 
...
try:
    ...
    st.error("⚠️ Error: No se pudo cargar el modelo. Verifique que el archivo 'tabnet_model.pkl' existe en la carpeta 'algoritmos'.")
    st.stop()
